...
public class BooksControllerTest {
    ...
    public void testBooksController() {
        ...
        HttpResponse<Integer> rsp = null;
        try {
            rsp = rxHttpClient.toBlocking().exchange(HttpRequest.GET("/books/stock/1491950358"), Integer.class);
    ...
    public void testBooksControllerWithNonExistingIsbn() {
        ...
        boolean noExceptionThrown = true;
        try {
            rxHttpClient.toBlocking().exchange(HttpRequest.GET("/books/stock/XXXXX"), Integer.class);
        } catch (HttpClientResponseException e) {
            noExceptionThrown = false;
            ex = e;
        }
